...
Label(frame1, text="WELCOME", fg="darkred", font="papyrus 35 bold", bg="darkseagreen1").pack()
Label(frame1, text="TO", fg="darkred", font="papyrus 35 bold", bg="darkseagreen1").pack()
Label(frame1, text="KIDS  LEARNING  GAME", fg="darkred", font="papyrus 35 bold", bg="darkseagreen1").pack()

Label(frame1, text="Click On the Image to Continue the Game...", fg="midnightblue", font="garamond 25 bold", bg="darkseagreen1").pack(anchor=NW, padx=10, pady=10)
...
Label(frame2, text="BIRDS", bg="darkseagreen1", fg="black", font="garamond 20 bold").pack(side=LEFT, padx=70, pady=5)
Label(frame2, text="FLOWERS", bg="darkseagreen1", fg="black", font="garamond 20 bold").pack(side=LEFT, padx=15, pady=5)
Label(frame2, text="ANIMALS", bg="darkseagreen1", fg="black", font="garamond 20 bold").pack(side=LEFT, padx=50, pady=5)
Label(frame2, text="FRUITS", bg="darkseagreen1", fg="black", font="garamond 20 bold").pack(side=LEFT, padx=20, pady=5)
Label(frame2, text="PLAYERS", bg="darkseagreen1", fg="black", font="garamond 20 bold").pack(side=LEFT, padx=50, pady=5)

frame3 = Frame(window, bg="darkseagreen1")
frame3.pack(anchor=NW, fill=BOTH)

Label(frame3, text="Press EXIT to End Playing...", fg="purple", font="garamond 15 bold", bg="darkseagreen1").pack(side=LEFT, padx=10, pady=25)
Button(frame3, text="EXIT", bg="lightsalmon", fg="black", bd=3, cursor="arrow", command=exit).pack(side=LEFT, padx=10, pady=25, ipadx=30)
